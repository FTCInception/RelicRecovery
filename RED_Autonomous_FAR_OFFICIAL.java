...
@Autonomous(name="RED_Autonomous_FAR", group="RED_FAR")

public class RED_Autonomous_FAR_OFFICIAL extends LinearOpMode {
    ...
    public void runOpMode()
    {
        ...
        //strafe right
        movement(.25, 0.25, 0.25, 0.25, eTime, 1);
        movement(.25,-.25,-.25,.25,eTime,1);
        movement(0, 0, 0, 0, eTime, .1);
        movement(.5,.5,-.5,-.5, eTime,1.25);
        movement(0, 0, 0, 0, eTime, .1);
        movement(-.25,-.25,-.25,-.25, eTime, 1);
